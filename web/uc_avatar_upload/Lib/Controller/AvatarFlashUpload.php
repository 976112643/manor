...
class Controller_AvatarFlashUpload extends Controller_Base{
    ...
    public function showuploadAction() {
        ...
        if( $returnhtml == 1 ) {
            $result = '<style>body:{margin:0;}object{position:absolute;top:-1px; left:-1px;}</style><object classid="clsid:d27cdb6e-ae6d-11cf-96b8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=9,0,0,0" width="450" height="253" id="mycamera" align="middle">
		...
		</object><script>function updateavatar() {window.top.location.reload();}</script>';
            return $result;
        } else {
            return array(
            'width', '450',
